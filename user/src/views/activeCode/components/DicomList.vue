    ...
    <div style="margin-bottom:20px;">
      <el-dropdown  @command="handleCommand">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="1">周卡激活码</el-dropdown-item>
          <el-dropdown-item command="2">月卡激活码</el-dropdown-item>
          <el-dropdown-item command="3">季卡激活码</el-dropdown-item>
          <el-dropdown-item command="4">年卡激活码</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
    <el-row>
